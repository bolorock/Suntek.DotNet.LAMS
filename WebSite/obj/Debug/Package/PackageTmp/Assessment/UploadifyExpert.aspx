<%@ Page Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true" CodeBehind="UploadifyExpert.aspx.cs" Inherits="WebSite.UploadifyExpert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlace" runat="server">
    <script type="text/javascript">
        $(document).ready(function () {
            $("#ctl00_contentPlace_ddlRole").change(function () {
                $('#uploadify').uploadifySettings('scriptData', { 'type': '1', 'surveyID': '<%= SurveyID %>', 'roleID': $("#ctl00_contentPlace_ddlRole").val() });
             });
            $("#uploadify").uploadify({
                'uploader': '../Scripts/JQuery.uploadify/uploadify.swf',
                'script': 'UploadifyExpert.aspx',
                'scriptData': { 'type': '1', 'surveyID': '<%= SurveyID %>', 'roleID': $("#ctl00_contentPlace_ddlRole").val() },
    ...
    <div>
        <a href="../FileTemplate/评分人导入表.xls" style="margin-left: 20px; text-align: left">下载模版</a>&nbsp;&nbsp;&nbsp;&nbsp;
