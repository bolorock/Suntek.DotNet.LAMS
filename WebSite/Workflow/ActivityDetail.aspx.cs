    ...
    public partial class ActivityDetail : BasePage
    {
        ...
        public void InitUI()
        {
            ...
            else if (ActivityInfo.ActivityType == ActivityType.EndActivity)
            {
                ...
                cboJoinType.BindCombox(SplitType.AND);
        ...
        public void Bind4DropDownList(Enum value, DropDownList dropDownList)
        {
            ...
            {
                ListItem listItem = new ListItem(values[i].Value, values[i].Key);
        ...
        public string Save(string argument)
        {
            ...
            if (!string.IsNullOrEmpty(TypeName))
            {
                try
                {
                    Type type = Assembly.Load("WorkflowDefinition").GetType(string.Format("EAFrame.Workflow.Definition.{0}", TypeName));
                    ...
                    processDefine.SafeAddActivity(activity);
