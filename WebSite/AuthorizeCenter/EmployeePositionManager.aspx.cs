...
namespace WebSite
{
    public partial class EmployeePositionManager : BasePage
    {
 		private EmployeePositionService employeePositionService=new EmployeePositionService();
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("EmployeePositionDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<EmployeePosition> result = employeePositionService.FindAll(GetFilterParameters(), pageInfo);
