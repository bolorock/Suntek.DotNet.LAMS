    ...
    $.formValidator =
{
    ...
    pageIsValid: function(validatorgroup) {
        ...
        var isvalid = true;
        var num = 0;
        var thefirstid = "", thefirsterrmsg ,allerrmsg = "";
            ...
            if (elem.settings[0].bind) {
                ...
                if (returnObj) {
                    ...
                    if (!returnObj.isvalid) {
                        ...
                        num += 1 ;
                        allerrmsg += num+"."+(returnObj.errormsg == "" ? returnObj.setting.onerror : returnObj.errormsg)+"      ";
                    }
        ...
        if (isvalid) {
            ...
            //处理错误信息，显示所有错误提示或第一个错误提示
            initConfig.onerror(initConfig.showallerror?allerrmsg:thefirsterrmsg, obj);
