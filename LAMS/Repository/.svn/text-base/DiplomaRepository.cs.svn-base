...
{
    public class DiplomaRepository :Repository<string, Diploma>
    {
		#region Fields
		private static readonly ILog log = LogManager.GetLogger(typeof(DiplomaRepository));
		#endregion
