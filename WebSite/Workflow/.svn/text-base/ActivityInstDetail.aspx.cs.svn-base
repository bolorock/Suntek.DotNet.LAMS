...
namespace WebSite
{
    public partial class ActivityInstDetail : BasePage
    {
       	...
       	protected bool ShowPageDetail()
        {
            ...
            ActivityInst entity =activityInstService.GetDomain(CurrentId);
		...
		#region ---操作处理方法---
		protected ActivityInst GetDomainObject()
		{
            ActivityInst  activityInst = activityInstService.GetDomain(CurrentId);

            if (activityInst == null)
            {
                activityInst = new ActivityInst();
				activityInst.ID=CurrentId;
            }

			GetControlValues(ref activityInst);	
