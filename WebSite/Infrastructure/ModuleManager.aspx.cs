...
namespace WebSite
{
    public partial class ModuleManager : BasePage
    {
        ...
        protected void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("ModuleDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        public void Delete()
        {
            ...
            try
            {
                moduleService.Delete(CurrentId);
        ...
        {
            IPageOfList<SunTek.EAFrame.Infrastructure.Domain.Module> result = moduleService.FindAll(GetFilterParameters(), pageInfo);
