...
namespace WebSite
{
    public partial class PrivilegeDetail : BasePage
    {
       	...
       	protected bool ShowPageDetail()
        {
            ...
            Privilege entity =privilegeService.GetDomain(CurrentId);
		...
		#region ---操作处理方法---
		protected Privilege GetDomainObject()
		{
            Privilege  privilege = privilegeService.GetDomain(CurrentId);

            if (privilege == null)
            {
                privilege = new Privilege();
				privilege.ID=CurrentId;
            }

			GetControlValues(ref privilege);	
