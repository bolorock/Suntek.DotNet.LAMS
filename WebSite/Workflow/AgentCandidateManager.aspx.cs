...
namespace WebSite
{
    public partial class AgentCandidateManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("AgentCandidateDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<AgentCandidate> result = agentCandidateService.FindAll(GetFilterParameters(), pageInfo);
