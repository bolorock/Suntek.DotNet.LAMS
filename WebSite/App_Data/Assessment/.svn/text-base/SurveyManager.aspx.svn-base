    ...
    <script type="text/javascript" language="javascript">
        ...
        function save(me, argument) {
            ...
            if (values.length > 0) {
                ...
                parameter["Category"] = $.trim(values.eq(3).find("input").eq(0).val());
                parameter["LimitTime"] = $.trim(values.eq(4).text());
                parameter["EndTime"] = $.trim(values.eq(5).text());
