...
namespace WebSite
{
    public partial class PersonalParamDetail : BasePage
    {
       	...
       	protected bool ShowPageDetail()
        {
            ...
            PersonalParam entity =personalParamService.GetDomain(CurrentId);
		...
		#region ---操作处理方法---
		protected PersonalParam GetDomainObject()
		{
            PersonalParam  personalParam = personalParamService.GetDomain(CurrentId);

            if (personalParam == null)
            {
                personalParam = new PersonalParam();
				personalParam.ID=CurrentId;
            }

			GetControlValues(ref personalParam);	
