...
namespace EAFrame.Workflow.Definition
{
    ...
    public class MultiWorkItem : ConfigureElement
    {
        ...
        /// 多工作项分配策略
        /// </summary>
        public string WorkitemNumStrategy
        {
            get
            {
                return Properties.GetSafeValue<string>("workitemNumStrategy");
            }
            set
            {
        ...
        public string FinishRule
        {
            get
            {
                return Properties.GetSafeValue<string>("finishRule");
            }
            set
            {
        ...
        public MultiWorkItem(IConfigureElement parent, XElement xElem)
