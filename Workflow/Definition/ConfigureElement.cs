...
namespace EAFrame.Workflow.Definition
{
    ...
    {
        protected ILog log = LogManager.GetLogger(typeof(ConfigureElement));
        ...
        /// 父结点
        /// </summary>
        public IConfigureElement Parent
        {
            get;
            set;
        }
        ...
        public ConfigureElement(IConfigureElement parent, string nodeName)
        ...
        public ConfigureElement(IConfigureElement parent, string nodeName, XElement xElem)
        ...
        public ConfigureElement(IConfigureElement parent, string nodeName, string nodeValue)
        ...
        /// <param name="nodeValue"></param>
        /// <param name="xElem"></param>
        public ConfigureElement(IConfigureElement parent, string nodeName, string nodeValue, XElement xElem)
        {
            Parent = parent;
        ...
        public virtual void Save(string fileName)
        {
            ...
            IConfigureElement parent = Parent;
            try
            {
                if (parent == null)
                {
                ...
                if (this.GetType() == typeof(WorkflowDefine))
                {
                    ToXElement().Save(fileName);
                    return;
                }
        ...
        public virtual void Save()
        {
            ...
            IConfigureElement parent = this;
            while (parent != null && parent.Parent != null) parent = parent.Parent;

            if (parent is WorkflowDefine)
            {
                WorkflowDefine wf = (WorkflowDefine)parent;
