...
<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="ReportManager.aspx.cs" Inherits="WebSite.ReportManager" %>
    ...
    <div id="divContent" class="div_content">
        <SunTek:PagedGridView ID="gvList" runat="server" PageIndex="1" CssClass="gridview" DataKeyNames="ID">
            <Columns>
		        ...
		        <asp:TemplateField HeaderText="报告文件">
                    <ItemTemplate>
						<%#Eval("UploadFileID")%>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <div id="filterDialog" title="查询">
        ...
        <fieldset>
            <dl>
				...
				<dt class="rowlable">编号</dt>
				<dd class="rowinput">
						<suntek:ChooseBox ID="filterCode" OpenUrl="CodeTree.aspx" DialogTitle="选择编号"
						runat="server"></suntek:ChooseBox>
				</dd>
				<dt class="rowlable">报告文件</dt>
				<dd class="rowinput">
						<suntek:ChooseBox ID="filterUploadFileID" OpenUrl="UploadFileIDTree.aspx" DialogTitle="选择报告文件"
						runat="server"></suntek:ChooseBox>
				</dd>
