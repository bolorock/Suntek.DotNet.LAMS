...
namespace WebSite
{
    public partial class MessagePumpManager : BasePage
    {
 		private MessagePumpService messagePumpService=new MessagePumpService();
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("MessagePumpDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<MessagePump> result = messagePumpService.FindAll(GetFilterParameters(), pageInfo);
