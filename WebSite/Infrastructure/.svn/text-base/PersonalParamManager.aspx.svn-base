...
<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="PersonalParamManager.aspx.cs" Inherits="WebSite.PersonalParamManager" %>
        ...
        <suntek:PagedGridView ID="gvList" runat="server" PageIndex="1" CssClass="gridview"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <span class='btn_delete' onclick="del(this)" title='删除'>&nbsp;&nbsp;&nbsp;</span> | <span onclick="save(this);"
