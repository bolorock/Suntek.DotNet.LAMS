...
namespace WebSite
{
    public partial class DiplomaDetail : BasePage
    {
       	...
       	protected bool ShowPageDetail()
        {
            ...
            Diploma entity =diplomaService.GetDomain(CurrentId);
		...
		#region ---操作处理方法---
		protected Diploma GetDomainObject()
		{
            Diploma  diploma = diplomaService.GetDomain(CurrentId);

            if (diploma == null)
            {
                diploma = new Diploma();
				diploma.ID=CurrentId;
            }

			GetControlValues(ref diploma);	
