<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="OrgTree.aspx.cs" Inherits="WebSite.AuthorizeCenter.OrgTree" %>
    ...
    <script type="text/javascript">
        ...
        function initContextMenu() {
            $("li A").contextMenu({
                ...
                if (action == "addUser") {
                    $("#ifrMain", window.parent.document.body).attr("src", "UserDetail.aspx?ActionFlag=Add&CurrentId=" + el.context.parentNode.id);
                }
                if (action == "delDept") {
