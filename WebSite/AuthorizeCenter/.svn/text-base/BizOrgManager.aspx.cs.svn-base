...
namespace WebSite
{
    public partial class BizOrgManager : BasePage
    {
 		private BizOrgService bizOrgService=new BizOrgService();
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("BizOrgDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<BizOrg> result = bizOrgService.FindAll(GetFilterParameters(), pageInfo);
