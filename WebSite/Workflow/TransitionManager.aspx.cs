...
namespace WebSite
{
    public partial class TransitionManager : BasePage
    {
        ...
        public void ShowList(PagedGridView gvList, PageInfo pageInfo)
        {
            ...
            //IPageOfList<DataTable> result = transitionService.FindTransition(GetFilterParameters(),pageInfo).Cast<EAFrame.Core.IPageOfList<DataTable>>;//FindAll(GetFilterParameters(), pageInfo);
