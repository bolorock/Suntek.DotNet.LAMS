...
namespace WebSite
{
    public partial class WorkItemDetail : BasePage
    {
       	...
       	protected bool ShowPageDetail()
        {
            ...
            WorkItem entity =workItemService.GetDomain(CurrentId);
		...
		#region ---操作处理方法---
		protected WorkItem GetDomainObject()
		{
            WorkItem  workItem = workItemService.GetDomain(CurrentId);

            if (workItem == null)
            {
                workItem = new WorkItem();
				workItem.ID=CurrentId;
            }

			GetControlValues(ref workItem);	
