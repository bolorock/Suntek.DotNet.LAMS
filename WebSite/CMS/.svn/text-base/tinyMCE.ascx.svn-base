<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tinyMCE.ascx.cs" Inherits="WebSite.tinyMCE" %>

<script src="editors/tiny_mce_3_3_9_2/tiny_mce.js" type="text/javascript"></script>
