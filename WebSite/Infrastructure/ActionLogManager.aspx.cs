...
namespace WebSite
{
    public partial class ActionLogManager : BasePage
    {
        ...
        protected void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("ActionLogDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        public void Delete()
        {
            ...
            try
            {
                actionLogService.Delete(CurrentId);
                actionLogService.ClearCache();
        ...
        {
            IPageOfList<ActionLog> result = actionLogService.FindAll(GetFilterParameters(), pageInfo);
