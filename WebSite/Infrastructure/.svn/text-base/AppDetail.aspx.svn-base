...
<%@ Page Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="AppDetail.aspx.cs" Inherits="WebSite.AppDetail" %>
   ...
   <script type="text/javascript" language="javascript">
    ...
    <div class="div_block">
        ...
        <div class="div_row">
            ...
            <div class="div_row_input">
					   <suntek:ComboBox ID="cboIsUse" DropDownStyle="DropDownList" 
            ...
            <div class="div_row_input">
				<suntek:DatePicker ID="dtpUseTime" runat="server"></suntek:DatePicker>
            </div>
        </div>
        <div class="div_row">
            <div class="div_row_lable">
