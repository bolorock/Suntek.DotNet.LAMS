<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="ResourceTree.aspx.cs" Inherits="WebSite.ResourceTree" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        var iconMenu = "<%=RootPath %>Skins/<%=Skin %>/Images/menu.gif";
        var iconPage = "<%=RootPath %>Skins/<%=Skin %>/Images/page.png";
        var iconButton = "<%=RootPath %>Skins/<%=Skin %>/Images/page.png";
        ...
        function ajaxTreeNodeAction(id, value) {
            $("#ifrResource", window.parent.document.body).attr("src", "ResourceDetail.aspx?ActionFlag=Update&CurrentId=" + id);
        }
