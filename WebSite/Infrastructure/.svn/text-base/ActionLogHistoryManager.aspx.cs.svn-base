...
namespace WebSite
{
    public partial class ActionLogHistoryManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("ActionLogHistoryDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<ActionLogHistory> result = actionLogHistoryService.FindAll(GetFilterParameters(), pageInfo);
