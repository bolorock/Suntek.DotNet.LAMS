<%@ Page Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="EducationStructureReport.aspx.cs" Inherits="WebSite.EducationStructureReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function exportExcel() {
            ...
            window.open("../LAMS/ExportXMLExcel.aspx?corpID=<%= CorpID %>&type=5&filterStr=" + str);
        }
    </script>
</asp:Content>
        ...
        <asp:Chart ID="Chart1" runat="server" Palette="BrightPastel" BackColor="#F3DFC1"
            ...
            <Titles>
                <asp:Title ShadowColor="32, 0, 0, 0" Font="Trebuchet MS, 14.25pt, style=Bold" ShadowOffset="3"
                    Text="后备经理学历结构" Name="Title1" ForeColor="26, 59, 105">
                </asp:Title>
            </Titles>
            <Legends>
