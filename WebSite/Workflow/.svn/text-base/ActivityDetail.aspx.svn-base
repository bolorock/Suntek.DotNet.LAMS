<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Page.Master"
    CodeBehind="ActivityDetail.aspx.cs" Inherits="WebSite.Workflow.ActivityDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlace" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function addParticipantor() {
            var participantors = openDialog("actionDialog", "添加参与者", "ChooseParticipantor.aspx", 980, 700, true, 1);
            if (participantors == null) return;
            if (participantors.length != 0) {
                var table = $("table", "#gvOrgizationOrRole");
       ...
       $(document).ready(function () {
        ...
        function addParameter(me, argument) {
            ...
            var newRow = "<tr ondblclick=\"rowDbClick(this,'',true)\" onmouseout='rowOut(this);' onclick=\"rowClick(this,'',true)\" style='cursor: hand'>"
                            ...
                            + "<td  style='width:10%' flag='operate' ><span class='btn_up' title='上移' onclick=\"executeOperate(this,'up')\">&nbsp;&nbsp;&nbsp;</span> ｜ <span class='btn_down' title='下移' onclick=\"executeOperate(this,'down')\">&nbsp;&nbsp;&nbsp;</span></td>"
                            + "</tr>";
        ...
        function delParticipantor(me) {
            ...
            var table = $("table", "#gvOrgizationOrRole");
            var rad = $("#gvOrgizationOrRole").find(":checked ").first(); //.val();
            rad.parent().parent().remove();
            changIndex(table);
                return;
            }
        ...
        function rowClick(me, id, remember) {
            ...
            if (currentRow && currentRow != me) {
                $(currentRow).find("td").each(function (i) {
                    ...
                    if (text[0] && text.attr("type") == "checkbox") {
                        var value = $(this).find(":checkbox").attr("checked") == true ? "是" : "否";
                        $(this).text(value);
                    }
                    else if (text[0] && text.attr("type") != "radio") {
            ...
            $("td", me).each(function (i) {
                ...
                else if (i == 4)//控件
                {
                    ...
                    if (innerText == "文本") {
                        ...
                        $(this).append("<select style='width:98%'><option>文本</option><option selected='selected'>日期控件</option><option>月份控件</option><option>年份控件</option><option>多选项列表</option><option>复选框</option><option>单选项列表</option><option>选择框</option><option>选择树</option></select>");
                    }
        ...
        function save(me, argument) {
            ...
            var activityDetail = getObjectValue("tabcontainer");
            //参与者
            var tblParticipantor = $("table", "#gvOrgizationOrRole");
                ...
                if (i > 0) {
                    ...
                    if (tds.length > 0) {
                        ...
                        if (controlType == "文本")
                            ...
                            item["ControlType"] = 6;
                        else if (controlType == "异步")
                            item["ControlType"] = 7;
                        else if (controlType == "多选框")
                            item["ControlType"] = 8;
    ...
    <div id="tabcontainer">
        <ul>
            <li><a href="#1"><span>基本</span></a></li>
            <li><a href="#2"><span>参与者</span></a></li>
            <li><a href="#3"><span>表单</span></a></li>
            <li><a href="#4"><span>时间限制</span></a></li>
            <li><a href="#5"><span>多工作项</span></a></li>
            <li><a href="#6"><span>触发事件</span></a></li>
            <li><a href="#7"><span>回退</span></a></li>
            <li><a href="#8"><span>自由流</span></a></li>
            <li><a href="#9"><span>启动策略</span></a></li>
            <%--<li><a href="#10"><span>扩展</span></a></li>--%>
        </ul>
        <div id="1">
            <%--基本  --%>
            <div class="div_row">
            ...
            <div class="div_row">
                ...
                <div class="div_row_input" id="input_joinType" runat="server">
                    <suntek:Combox ID="cboJoinType" IsSingle="true" runat="server"></suntek:Combox>
                </div>
                ...
                <div class="div_row_input" id="input_splitType" runat="server">
                    <suntek:Combox ID="cboSplitType" IsSingle="true" runat="server"></suntek:Combox>
                </div>
            </div>
        ...
        <div id="2">
            ...
            <div class="div_row">
                ...
                <div class="div_row_input" style="text-align: right; width: 80%">
            ...
            <div class="div_row" id="orgorrole" style="height: 200px; overflow:auto;">
                <suntek:PagedGridView ID="gvOrgizationOrRole" CssClass="gridview" IncludeRowDoubleClick="false"
                    runat="server">
                    <Columns>
                      <asp:TemplateField HeaderText="选择">
                        ...
                        <asp:TemplateField HeaderText="类型">
                            <ItemTemplate>
                                <%#Eval("ParticipantorType").ToSafeString().Cast<EAFrame.Workflow.Enums.ParticipantorType>().GetRemark()%>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    ...
                    <asp:Repeater runat="server" ID="gvformList">
                        <ItemTemplate>
                            ...
                            onclick="rowClick(this,'',true)" style="cursor: pointer" >
                                ...
                                <td>
                                    <%#Eval("DataType").ToSafeString().Cast<EAFrame.Workflow.Enums.DataType>().GetRemark()%>
                                </td>
                                <td>
                                    <%#Eval("ControlType").ToSafeString().Cast<EAFrame.Workflow.Enums.ControlType>().GetRemark()%>
                                </td>
                                <td>
                                ...
                                <td>
                                    <%#Eval("AccessPattern").ToSafeString().Cast<EAFrame.Workflow.Enums.AccessPattern>().GetRemark()%>
                                </td>
                                <td flag="operate">
        ...
        <div id="4">
            ...
            <div class="div_row" id="strategy">
                ...
                <div class="div_row_input">
                    <suntek:Combox runat="server" ID="cboCalendarType" IsSingle="true" />
                </div>
            </div>
            <div class="div_row_left">
                时间限制策略
                    ...
                    <asp:Repeater runat="server" ID="rptTriggerEvent">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <%#Eval("TriggerEventType").ToSafeString().Cast<EAFrame.Workflow.Enums.TriggerEventType>().GetRemark()%>
                                </td>
                                <td>
                                    <%#Eval("EventAction")%>
                                </td>
                                <td>
                                    <%#Eval("InvokePattern").ToSafeString().Cast<EAFrame.Workflow.Enums.InvokePattern>().GetRemark()%>
                                </td>
                                </tr>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        <div id="7">
            ...
            <div class="div_row">
                <div class="div_row_lable">
                    类型</div>
                <div class="div_row_input">
                    <suntek:Combox ID="cboRollbackType" runat="server" IsSingle="true"></suntek:Combox>
                </div>
            </div>
            <div class="div_row">
                <div class="div_row_lable">
                    ...
                    <asp:Repeater runat="server" ID="rptRollback">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                     <%#Eval("ParameterDirection").ToSafeString().Cast<EAFrame.Workflow.Enums.ParameterDirection>().GetRemark()%>
                                </td>
                                </tr>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        <div id="9">
            ...
            <div class="div_row">
                ...
                <div class="div_row_input">
                    <suntek:Combox runat="server" ID="cboURLType" IsSingle="true" />
                </div>
            </div>
            <div class="div_row">
                <div class="div_row_lable">
