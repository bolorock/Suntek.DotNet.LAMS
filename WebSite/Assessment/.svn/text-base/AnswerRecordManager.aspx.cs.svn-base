...
namespace WebSite
{
    public partial class AnswerRecordManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("AnswerRecordDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<AnswerRecord> result = answerRecordService.FindAll(GetFilterParameters(), pageInfo);
