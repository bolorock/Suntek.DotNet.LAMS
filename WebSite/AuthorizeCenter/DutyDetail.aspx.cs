...
namespace WebSite
{
    public partial class DutyDetail : BasePage
    {
       	...
       	protected bool ShowPageDetail()
        {
            ...
            Duty entity =dutyService.GetDomain(CurrentId);
		...
		#region ---操作处理方法---
		protected Duty GetDomainObject()
		{
            Duty  duty = dutyService.GetDomain(CurrentId);
