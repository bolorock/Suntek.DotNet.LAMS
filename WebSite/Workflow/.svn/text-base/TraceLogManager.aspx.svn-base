...
<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="TraceLogManager.aspx.cs" Inherits="WebSite.TraceLogManager" %>
        ...
        <SunTek:PagedGridView ID="gvList" runat="server" PageIndex="1" CssClass="gridview" DataKeyNames="ID">
            <Columns>
		        ...
		        <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
						<%# RemarkAttribute.GetEnumRemark((EAFrame.Workflow.Enums.Operation)Enum.Parse(typeof(EAFrame.Workflow.Enums.Operation), Eval("ActionType").ToString()))%>
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <div id="filterDialog" title="查询">
        ...
        <fieldset>
            <dl>
				...
				<dd class="rowinput">
					   <suntek:ComboBox ID="filterActionType" DropDownStyle="DropDownList" 
