...
namespace WebSite
{
    public partial class WidgetsManager : BasePage
    {
        ...
        protected void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("WidgetsDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        public void Delete()
        {
            ...
            try
            {
                widgetsService.Delete(CurrentId);
                widgetsService.ClearCache();
        ...
        {
            IPageOfList<SunTek.CMS.Domain.Widgets> result = widgetsService.FindAll(GetFilterParameters(), pageInfo);
