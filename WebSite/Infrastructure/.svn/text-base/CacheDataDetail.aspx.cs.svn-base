...
namespace WebSite
{
    public partial class CacheDataDetail : BasePage
    {
       	...
       	protected bool ShowPageDetail()
        {
            ...
            CacheData entity =cacheDataService.GetDomain(CurrentId);
		...
		#region ---操作处理方法---
		protected CacheData GetDomainObject()
		{
            CacheData  cacheData = cacheDataService.GetDomain(CurrentId);

            if (cacheData == null)
            {
                cacheData = new CacheData();
				cacheData.ID=CurrentId;
            }

			GetControlValues(ref cacheData);	
