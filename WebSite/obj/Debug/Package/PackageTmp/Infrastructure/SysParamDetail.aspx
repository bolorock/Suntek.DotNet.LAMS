...
<%@ Page Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="SysParamDetail.aspx.cs" Inherits="WebSite.SysParamDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlace" runat="server">
   ...
   <script type="text/javascript" language="javascript">
        ...
        function initValidator()
        {
            ...
            /*非空字段*/
            $("#<%=txtName.ClientID%>").formValidator().inputValidator({ min: 1, onerror: "【参数名】不能为空" });
            /*非空字段*/
            $("#<%=txtValue.ClientID%>").formValidator().inputValidator({ min: 1, onerror: "【参数值】不能为空" });
			/*默认验证字段*/
            ...
            /*非空字段*/
            $("#<%=txtModifier.ClientID%>").formValidator().inputValidator({ min: 1, onerror: "【修改者】不能为空" });
			/*日期*/
    ...
    <div class="div_block">
        ...
        <div class="div_row">
            ...
            <div class="div_row_lable">
			<label for="<%=txtModifier.ClientID%>" class="label">
			<em>*</em>
                修改者
			</label>
            </div>
            <div class="div_row_input">
                <asp:TextBox ID="txtModifier" runat="server" CssClass="text"></asp:TextBox>
            </div>
        </div>
        <div class="div_row">
            <div class="div_row_lable">
