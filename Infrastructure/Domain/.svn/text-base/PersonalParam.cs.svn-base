...
{
    public partial class PersonalParam :DomainObject<string>
    {
        #region Fields
		...
		public PersonalParam(string id,string name,string value,string description,string creator,System.DateTime createTime)
		{
		  this.ID=id;
		this._name=name;
		this._value=value;
