...
namespace WebSite
{
    public partial class ExtendAttrManager : BasePage
    {
 		private ExtendAttrService extendAttrService=new ExtendAttrService();
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("ExtendAttrDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<ExtendAttr> result = extendAttrService.FindAll(GetFilterParameters(), pageInfo);
