...
namespace SunTek.EAFrame.AuthorizeCenter.Service
{
    ...
    {
		#region Fields
		private readonly ILog log = LogManager.GetLogger(typeof(RolePrivilegeService));
		#endregion
        ...
        public void SaveRolePrivilege(IList<RolePrivilege> privileges)
        {
            ...
            {
                //删除已经存在的
                repository.ExecuteSql<RolePrivilege>(string.Format("delete from AC_RolePrivilege where RoleID='{0}'", privileges[0].RoleID));
