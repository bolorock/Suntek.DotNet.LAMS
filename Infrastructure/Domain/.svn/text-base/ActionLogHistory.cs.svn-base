...
{
    public partial class ActionLogHistory :DomainObject<string>
    {
        #region Fields
		...
		public ActionLogHistory(string id,string userName,short logType,string clientIP,string appModule,string message,short result,string userID,System.DateTime createTime,System.DateTime archiveTime)
		{
		  this.ID=id;
