...
namespace WebSite
{
    public partial class ActivityInstManager : BasePage
    {
 		private ActivityInstService activityInstService=new ActivityInstService();
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("ActivityInstDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<ActivityInst> result = activityInstService.FindAll(GetFilterParameters(), pageInfo);
