...
namespace WebSite
{
    public partial class ArchiveMessageManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("ArchiveMessageDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<ArchiveMessage> result = archiveMessageService.FindAll(GetFilterParameters(), pageInfo);
