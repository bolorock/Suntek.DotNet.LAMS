...
namespace WebSite
{
    public partial class CandidateManagerManager : BasePage
    {
        private CandidateManagerService candidateManagerService = new CandidateManagerService();
        private EmployeeModelService employeeModelService = new EmployeeModelService();
        ...
        protected void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("CandidateManagerDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        public void Delete()
        {
            ...
            try
            {
                string code = candidateManagerService.GetDomain(CurrentId).Code;
                Dictionary<string,object> dic=new Dictionary<string,object>();
                dic.Add("Code",code);
                string employeeID=new EmployeeService().FindOne(dic).ID;
                employeeModelService.DeleteEmployeeModel(employeeID,CurrentId);
