<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="RoleManager.aspx.cs" Inherits="WebSite.RoleManager" %>
    ...
    <script type="text/javascript" language="javascript">
       ...
       function add(me, argument) {
            ...
            var newRow = "<tr ondblclick=\"rowDbClick(this,'',true)\" onmouseout='rowOut(this);' onclick=\"rowClick(this,'',true)\" style='cursor: hand'>"
                          ...
                          +"<td  style='width:20%;'><%=User.Name %></td><td style='width:20%;'><%=DateTime.Now.ToShortDateString() %></td>" +
                            "</tr>";
        ...
        function setPrivilege(me, argument) {
            ...
            openOperateDialog("设置权限", "RolePrivilegeManager.aspx?RoleID=" + rad, 500, 500);
        }
        ...
        function setPrivilegeMeta(me, argument) {
            ...
            openOperateDialog("设置数据权限", "MetaDataManager.aspx?RoleID=" + rad, 500, 500);
        }
