...
namespace WebSite
{
    public partial class ExamPaperSubjectManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("ExamPaperSubjectDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<ExamPaperSubject> result = examPaperSubjectService.FindAll(GetFilterParameters(), pageInfo);
