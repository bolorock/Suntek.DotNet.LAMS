...
namespace WebSite
{
    public partial class SysParamManager : BasePage
    {
        ...
        protected void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("SysParamDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        public string Delete(string argument)
        {
            ...
            try
            {
                ...
                {
                    sysParamService.Delete(argument);
        ...
        public string Save(string argument)
        {
            ...
            try
            {
                ...
                if (isParam.Count > 0 && string.IsNullOrEmpty(sysParam.ID))
                {
                ...
                //记录操作日志
                AddActionLog(sysParam, PageContext.Action, actionResult, actionMessage);
