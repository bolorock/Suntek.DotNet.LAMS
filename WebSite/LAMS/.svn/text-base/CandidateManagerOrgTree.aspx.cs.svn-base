...
namespace WebSite
{
    public partial class CandidateManagerOrgTree : BasePage
    {
        ...
        private void InitTree(int grade)
        {
            ...
            AjaxTreeNode ParentNode = new AjaxTreeNode()
            {
                ...
                LinkUrl = "../AuthorizeCenter/EmployeeManager.aspx?layer=1&grade="+grade+(grade!=0 ? "&corpID="+User.CorpID:string.Empty),
                Target = "ifrMain",
            ...
            AjaxTreeNode nodeTwo = new AjaxTreeNode()
            {
                ...
                Tag = "11",
                NodeState=NodeState.Open,
                LinkUrl = "../AuthorizeCenter/EmployeeManager.aspx?layer=2&grade="+grade + (grade != 0 ? "&corpID=" + User.CorpID : string.Empty),
                Target = "ifrMain",
            ...
            AjaxTreeNode nodeThree = new AjaxTreeNode()
            {
                ...
                Tag = "12",
                NodeState = NodeState.Open,
                LinkUrl = "../AuthorizeCenter/EmployeeManager.aspx?layer=3&grade=" + grade + (grade != 0 ? "&corpID=" + User.CorpID : string.Empty),
                Target = "ifrMain",
                IcoSrc = string.Format("{0}Skins/{1}/Images/{2}", WebUtil.GetRootPath(), Skin, getResourceIcon(2.Cast<ResourceType>(ResourceType.Menu)))
            };
            ...
            if (grade == 0) //省公司人员才加正副职节点
            {
                nodePrincipal = new AjaxTreeNode()
                {
                    ...
                    Tag = "21",
                    NodeState = NodeState.Open,
                    LinkUrl = "../AuthorizeCenter/EmployeeManager.aspx?isChief=1",
                    Target = "ifrMain",
                ...
                nodeDeputy = new AjaxTreeNode()
                {
                    ...
                    Tag = "22",
                    NodeState = NodeState.Open,
                    LinkUrl = "../AuthorizeCenter/EmployeeManager.aspx?isChief=0",
                    Target = "ifrMain",
                    IcoSrc = string.Format("{0}Skins/{1}/Images/{2}", WebUtil.GetRootPath(), Skin, getResourceIcon(3.Cast<ResourceType>(ResourceType.Menu)))
                };
        ...
        private AjaxTreeNode CreateNode(Organization model,string grade,string parent,string pre="")
        {
            ...
            return new AjaxTreeNode()
            {
                ...
                LinkUrl = string.Format("../AuthorizeCenter/EmployeeManager.aspx?corpID={0}&layer={1}&parent={2}", model.ID, grade, parent),
                Target = "ifrMain",
