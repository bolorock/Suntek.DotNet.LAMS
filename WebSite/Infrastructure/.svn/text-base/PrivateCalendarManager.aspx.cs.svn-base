...
namespace WebSite
{
    public partial class PrivateCalendarManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("PrivateCalendarDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<PrivateCalendar> result = privateCalendarService.FindAll(GetFilterParameters(), pageInfo);
