<%@ Page Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="DictDetail.aspx.cs" Inherits="WebSite.DictDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlace" runat="server">
    ...
    <div id="dictDetail" class="div_block">
        ...
        <div class="div_row">
            ...
            <div class="div_row_input">
                <suntek:ChooseBox ID="chbParentID" OpenUrl="ParentIDTree.aspx" DialogTitle="选择父字典"
            ...
            <table id="tblDict" style="width: 100%; display: inline-table;">
                <thead>
                    <tr>
                        ...
                        <th style="width: 20%">
                            <span onclick="addDict();" class='btn_add' title='添加'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                        </th>
                    </tr>
                </thead>
                <asp:Repeater ID="rptDict" runat="server">
                    <ItemTemplate>
                        <tr ondblclick="rowDbClick(this,'',true)" onmouseout="rowOut(this);" onmouseover="rowOver(this);"
                            ...
                            <td flag="operate">
                                <span class='btn_delete' onclick="del(this)" title="删除">&nbsp;&nbsp;&nbsp;</span>
