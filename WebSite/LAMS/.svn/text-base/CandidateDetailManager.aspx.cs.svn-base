...
namespace WebSite
{
    public partial class CandidateDetailManager : BasePage
    {
 		private CandidateDetailService candidateDetailService=new CandidateDetailService();
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("CandidateDetailDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<CandidateDetail> result = candidateDetailService.FindAll(GetFilterParameters(), pageInfo);
