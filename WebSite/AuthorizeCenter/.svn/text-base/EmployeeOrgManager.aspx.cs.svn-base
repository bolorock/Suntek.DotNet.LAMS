...
namespace WebSite
{
    public partial class EmployeeOrgManager : BasePage
    {
 		private EmployeeOrgService employeeOrgService=new EmployeeOrgService();
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("EmployeeOrgDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<EmployeeOrg> result = employeeOrgService.FindAll(GetFilterParameters(), pageInfo);
