<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true"
    CodeBehind="UploadFileManager.aspx.cs" Inherits="WebSite.UploadFileManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlace" runat="server">
    ...
    <div class="div_block" id="catalogDetail">
        ...
        <div class="div_row">
            ...
            <div class="div_row_input">
                <suntek:ChooseBox ID="chbParentID" OpenUrl="CatalogTree.aspx?Entry=Choose" DialogTitle="选择上级目录"
    ...
    <div id="filterDialog" title="查询">
        ...
        <fieldset>
            <dl>
                ...
                <dd class="rowinput">
                    <suntek:ComboBox ID="filterFileType" DropDownStyle="DropDownList" AppendDataBoundItems="true"
                        runat="server">
