<%@ Page Language="C#" MasterPageFile="~/Master/Page.Master" AutoEventWireup="true" CodeBehind="ReportsManager.aspx.cs"
 Inherits="WebSite.ReportsManager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlace" runat="server">
    <script language="javascript" type="text/javascript">
      ...
      <div id="treeContainer" style="width: 24%; float: left;">
        <iframe id="ifrTree" name="ifrTree" class="autoHeight" src="CorpTree.aspx?type=<%= Type %>" width="100%"
            height="100%" frameborder="0" scrolling="no"></iframe>
    </div>
    <div id="resourceContainer" style="float: left; width: 76%;">
        <iframe id="ifrMain" class="autoHeight" name="ifrMain" src="<%= IfrMainURL %>"
