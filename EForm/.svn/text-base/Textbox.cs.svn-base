...
namespace EAFrame.EForm
{
    public class TextBox : FieldControl
    {
        ...
        {
            string html = string.Format("<input name=\"{0}\"  type=\"text\" id=\"{0}\" class=\"text\" isRequired=\"{1}\" {2} value=\"{3}\" ", Field.Name, Field.Required, NumberValidateCode, GetFieldValue(values));
