...
namespace SunTek.EAFrame.Infrastructure.Domain
{
    public partial class UploadFile :DomainObject<string>
    {
		...
		public UploadFile(string id,string fileName,string uniqueName,short fileType,string catalogID,string filePath,string description,string ownerOrg,string creator,System.DateTime createTime)
		{
		  this.ID=id;
