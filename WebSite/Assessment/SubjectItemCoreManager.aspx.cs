...
namespace WebSite
{
    public partial class SubjectItemCoreManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("SubjectItemCoreDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<SubjectItemCore> result = subjectItemCoreService.FindAll(GetFilterParameters(), pageInfo);
