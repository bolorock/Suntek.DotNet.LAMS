...
namespace WebSite
{
    public partial class TraceLogManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("TraceLogDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            //IPageOfList<TraceLog> result = traceLogService.FindAll(GetFilterParameters(), pageInfo);
            DataTable result = traceLogService.FindTraceLog(GetFilterParameters(),pageInfo);
