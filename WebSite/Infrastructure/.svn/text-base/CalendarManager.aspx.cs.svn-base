...
namespace WebSite
{
    public partial class CalendarManager : BasePage
    {
        ...
        protected  void Redirect(string param)
        {
            ...
            Response.Redirect(string.Format("CalendarDetail.aspx?LastUrl={0}&Runat=1&ActionFlag={1}{2}{3}", Request.Url.PathAndQuery, PageContext.Action, currentIdParam, string.IsNullOrEmpty(param) ? param : "&" + param));
        }
        ...
        {
            IPageOfList<SunTek.EAFrame.Infrastructure.Domain.Calendar> result = calendarService.FindAll(GetFilterParameters(), pageInfo);
